...
public class Ater extends EnseignantTemporaire {
    ...
    public Ater(String nom, String prenom, String num_sec, Date dateDebutContrat, double salaire, Date dateFinContrat) throws SalaireIllegalException, DateContratIllegalException {
